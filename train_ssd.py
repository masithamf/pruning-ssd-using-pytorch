...
if __name__ == '__main__':
    ...
    logging.info(f"Using Adam optimizer. Learning rate: {args.lr}, "
                 f"Base net learning rate: {base_net_lr}, "
                 f"Extra Layers learning rate: {extra_layers_lr}.")
    
    # optimizer = SGD(params, lr=args.lr, momentum=args.momentum, weight_decay=args.weight_decay)
    # logging.info(f"Using SGD optimizer. Learning rate: {args.lr}, "
    #          f"Momentum: {args.momentum}, "
    #          f"Weight decay: {args.weight_decay}, "
    #          f"Base net learning rate: {base_net_lr}, "
    #          f"Extra Layers learning rate: {extra_layers_lr}.")
    
    # Extract last epoch if resuming
    last_epoch = -1
    if args.resume:
    ...
    scheduler = None
    logging.info("No learning rate scheduler used for Adam optimizer.")
